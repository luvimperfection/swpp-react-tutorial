...
class TodoList extends Component{
    ...
    state = {
        todos: [
            { id: 1, title: 'SWPP', content: 'take swpp class', done: true}, { id: 2, title: 'Movie', content: 'watch movie', done: false }, { id: 3, title: 'Dinner', content: 'eat dinner', done: false },
        ], 
        selectedTodo: null
    }
    ...
    clickTodoHandler = td => {
        if (this.state.selectedTodo === td) {
            // BAD: this.state.selectedTodo = null; 
            // it won't trigger rendering.
